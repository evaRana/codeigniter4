                ...
                <div class="card welcome-banner">
                    <div class="card-header p-0 card-no-border">
                        <div class="welcome-card"><img class="w-100 img-fluid"
                                src="<?= base_url('assets/'); ?>images/welcome-bg.png" alt=""><img
                                class="position-absolute img-1 img-fluid"
                                src="<?= base_url('assets/'); ?>images/img-1.png" alt=""><img
                                class="position-absolute img-2 img-fluid"
                                src="<?= base_url('assets/'); ?>images/img-2.png" alt=""><img
                                class="position-absolute img-3 img-fluid"
                                src="<?= base_url('assets/'); ?>images/img-3.png" alt=""><img
                                class="position-absolute img-4 img-fluid"
                                src="<?= base_url('assets/'); ?>images/img-4.png" alt=""><img
                                class="position-absolute img-5 img-fluid"
                                src="<?= base_url('assets/'); ?>images/img-5.png" alt="">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="d-flex align-center">
                            <h1>Hello, Amirreza <img src="<?= base_url('assets/'); ?>images/hand.png" alt=""></h1>
                        </div>
                        ...
                        <div class="d-flex align-center justify-content-between"><a class="btn btn-pill btn-primary"
                                ...
                                <svg class="stroke-icon">
                                    <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#watch"></use>
                        ...
                        <div class="d-flex align-center gap-3">
                            <h2>$4,875</h2><span class="text-primary">
                                ...
                                <svg class="stroke-icon stroke-primary">
                                    <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#arrow-down"></use>
                                </svg></span>
                        </div>
                            ...
                            <li>
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 bg-light-primary">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#job-bag"></use>
                                        </svg>
                                    </div>
                            ...
                            <li>
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 bg-light-secondary">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#employees">
                                            </use>
                                        </svg>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li>
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 bg-light-warning">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#hours-work">
                                            </use>
                                        </svg>
                                    </div>
                                    <div class="flex-grow-1">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/1.png" alt=""></div>
                                                <div class="flex-grow-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/2_1.png" alt=""></div>
                                                <div class="flex-grow-1">
                                                    <h6>Naomi watson</h6>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/3.png" alt=""></div>
                                                <div class="flex-grow-1">
                                                    <h6>Dann Petty</h6>
                                                </div>
                                            </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/1_1.png" alt=""></div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/2_2.png" alt=""></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Spring Bed</h6>
                                                    </a>
                                                    <p>Bought item</p>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/3_1.png" alt=""></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Long Dress</h6>
                                                    </a>
                                                    <p>Bought item</p>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/4.png" alt=""></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/5.png" alt=""></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Sofa Hauga</h6>
                                                    </a>
                                                    <p>Item Sold</p>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0"><img
                                                        src="<?= base_url('assets/'); ?>images/6.png" alt=""></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Apple iMac 19”</h6>
                                                    </a>
                                                    <p>Item Sold</p>
                    ...
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            ...
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown4" type="button" data-bs-toggle="dropdown"
                    ...
                    <div class="card-body audit-log">
                        <ul>
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-success"><img
                                        src="<?= base_url('assets/'); ?>images/checked.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-warning"><img
                                        src="<?= base_url('assets/'); ?>images/danger.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-danger"><img
                                        src="<?= base_url('assets/'); ?>images/cancel.png" alt=""></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                ...
                <div class="card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            ...
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown5" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa-solid fa-ellipsis"></i></button>
                ...
                <div class="card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            ...
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown6" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa-solid fa-ellipsis"></i></button>
                        ...
                        <ul>
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#box"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-warning border-light-warning">
                                    <svg class="stroke-icon stroke-warning">
                                        <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#dolar"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                    <svg class="stroke-icon stroke-danger">
                                        <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#round-right"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1"><a href="product-page.html">
                                        <h6>Review</h6>
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#pie-chart"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-warning border-light-warning">
                                    <svg class="stroke-icon stroke-warning">
                                        <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#globe"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1"><a href="product-page.html">
                                        <h6>Opened issue</h6>
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                    <svg class="stroke-icon stroke-none">
                                        <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#box-user"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <li class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                    <svg class="stroke-icon stroke-primary">
                                        <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#work-bag"></use>
                                    </svg>
                                </div>
                                <div class="flex-grow-1"><a href="product-page.html">
                                        <h6>Added new work</h6>
                        ...
                        <div class="header-top">
                            ...
                            <ul class="simple-wrapper nav nav-pills" id="myTab" role="tablist">
                                <li class="nav-item"><a class="nav-link" id="home-tab" data-bs-toggle="tab"
                                        href="#yearly" role="tab" aria-selected="true">Yearly</a></li>
                                <li class="nav-item"><a class="nav-link" id="profile-tabs" data-bs-toggle="tab"
                                        href="#monthly" role="tab" aria-selected="false">Monthly</a></li>
                                <li class="nav-item"><a class="nav-link active" id="contact-tab" data-bs-toggle="tab"
                                        href="#weekly" role="tab" aria-selected="false">Weekly</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-body pb-0">
                ...
                <div class="card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <h3>Top Users</h3>
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown7" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa-solid fa-ellipsis"></i></button>
                            ...
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img
                                            src="<?= base_url('assets/'); ?>images/01.png" alt=""></div>
                                    <div><a href="#">
                                            <h6>Alice Goodwin</h6>
                                        </a>
                                        <p>
                                            <svg class="stroke-icon">
                                                <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#map-icon">
                                                </use>
                                            </svg>Texas
                                        </p>
                                    </div>
                                ...
                                <button
                                    class="btn bg-light-success border-light-success text-success">Completed</button><span>$250.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img
                                            src="<?= base_url('assets/'); ?>images/02.png" alt=""></div>
                                    <div><a href="#">
                                            <h6>Smith Lovell</h6>
                                        </a>
                                        <p>
                                ...
                                <button
                                    class="btn bg-light-success border-light-success text-success">Completed</button><span>$682.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img
                                            src="<?= base_url('assets/'); ?>images/03.png" alt=""></div>
                                    <div><a href="#">
                                            <h6>Jones Brooks</h6>
                                        </a>
                                        <p>
                                ...
                                <button
                                    class="btn bg-light-warning border-light-warning text-warning">Pending</button><span>$387.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img
                                            src="<?= base_url('assets/'); ?>images/04.png" alt=""></div>
                                    <div><a href="#">
                                            <h6>Brown Acum</h6>
                                        </a>
                                        <p>
                                ...
                                <button
                                    class="btn bg-light-danger border-light-danger text-danger">Canceled</button><span>$355.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img
                                            src="<?= base_url('assets/'); ?>images/05.png" alt=""></div>
                                    <div><a href="#">
                                            <h6>Evans Mayo</h6>
                                        </a>
                                        <p>
                                ...
                                <button
                                    class="btn bg-light-success border-light-success text-success">Completed</button><span>$584.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img
                                            src="<?= base_url('assets/'); ?>images/06.png" alt=""></div>
                                    <div><a href="#">
                                            <h6>Wilson Pipes</h6>
                                        </a>
                                        <p>
                                ...
                                <button
                                    class="btn bg-light-success border-light-success text-success">Completed</button><span>$954.00</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between gap-2">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0 comman-round"><img
                                            src="<?= base_url('assets/'); ?>images/07.png" alt=""></div>
                                    <div><a href="#">
                                            <h6>Alice Pindar</h6>
                                        </a>
                                        <p>
                                ...
                                <button
                                    class="btn bg-light-danger border-light-danger text-danger">Canceled</button><span>$756.00</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card height-equal">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <h3>News & Update</h3>
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown8" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa-solid fa-ellipsis"></i></button>
                        ...
                        <ul>
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="<?= base_url('assets/'); ?>images/1_3.png" alt=""></div>
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="<?= base_url('assets/'); ?>images/2_3.png" alt=""></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="<?= base_url('assets/'); ?>images/3_2.png" alt=""></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="<?= base_url('assets/'); ?>images/4_1.png" alt=""></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="<?= base_url('assets/'); ?>images/5_1.png" alt=""></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                                        <h6>Business project research</h6>
                                    </a>
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="<?= base_url('assets/'); ?>images/6_1.png" alt=""></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="<?= base_url('assets/'); ?>images/7.png" alt=""></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                                        <h6>Added new work</h6>
                                    </a>
                                    <p class="text-truncate">Today’s news headlines,Breaking...</p>
                ...
                <div class="card height-equal">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <h3>Total Invest</h3>
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown1" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa-solid fa-ellipsis"></i></button>
                    ...
                    <div class="card-body total-invest">
                        <div class="row">
                            ...
                            <div class="col-6 col-md-12 invest-content text-center">
                                <svg class="stroke-icon">
                                    <use href="<?= base_url('assets/'); ?>images/icon-sprite.svg#chart-invest"></use>
                                </svg>
