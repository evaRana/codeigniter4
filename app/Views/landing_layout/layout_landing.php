...
<head>
    ...
    <!-- Favicon icon-->
    <link rel="icon" href="<?= base_url('assets/'); ?><?= base_url('assets/'); ?>landing-img/favicon.png
      " type="image/x-icon">

    <link rel="shortcut icon" href="<?= base_url('assets/'); ?><?= base_url('assets/'); ?>landing-img/favicon.png"
        type="image/x-icon">
    <!-- Google font-->
...
<body class="landing-page">
    ...
    <?= view('landing_layout/landing_header') ?>

    <?= $this->renderSection('content') ?>
   
    <?= view('landing_layout/landing_footer') ?>
