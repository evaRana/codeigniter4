<header class="page-header row">
    <div class="logo-wrapper d-flex align-items-center col-auto"><a href="index.html">
        <!-- <img class="light-logo img-fluid"
                src="<//?= base_url('assets/'); ?>images/logo1.png" alt="logo"> -->

                 <img class="light-logo img-fluid"
                src="<?= base_url(LOGO )?>" alt="logo">
                
                <img class="dark-logo img-fluid"
                src="<?= base_url('assets/'); ?>images/logo-dark.png" alt="logo"></a><a class="close-btn toggle-sidebar"
            href="javascript:void(0)">
            <svg class="svg-color">
                <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Category">
                </use>
            </svg></a></div>
        ...
        <div class="nav-right">
            <ul class="header-right">
                ...
                <li class="search d-lg-none d-flex"> <a href="javascript:void(0)">
                        <svg>
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Search"></use>
                        </svg></a></li>
                        ...
                        <ul class="pb-0">
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                        src="<?= base_url('assets/'); ?>images/1_2.png" alt="">
                            ...
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                        src="<?= base_url('assets/'); ?>images/2.png" alt="">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="f-w-600 font-primary">30-04-2024<span>Today</span><span
                                            ...
                                            <svg class="circle-color">
                                                <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#circle">
                                                </use>
                                            </svg></span></h6>
                                    <h5>Alice Goodwin</h5>
                        ...
                        <ul>
                                ...
                                <form class="mb-0">
                                    <div class="input-group">
                                        <input class="form-control" type="text" placeholder="Search Bookmark..."><span
                                            ...
                                            <svg class="svg-color">
                                                <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Search">
                                                </use>
                                            </svg></span>
                                    </div>
                                </form>
                            ...
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 btn-activity-primary"><a href="index.html">
                                        <svg class="svg-color">
                                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#cube"></use>
                                        </svg></a></div>
                                <div class="d-flex justify-content-between align-items-center w-100"><a
                                    ...
                                    <svg class="svg-color icon-star">
                                        <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#star"></use>
                                    </svg>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 btn-activity-secondary"><a href="to-do.html">
                                        <svg class="svg-color">
                                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#check"></use>
                                        </svg></a></div>
                                <div class="d-flex justify-content-between align-items-center w-100"><a
                            ...
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 btn-activity-danger"><a href="apex_chart.html">
                                        <svg class="svg-color">
                                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#pie"></use>
                                        </svg></a></div>
                                <div class="d-flex justify-content-between align-items-center w-100"><a
            ...
            <ul class="sidebar-menu" id="simple-bar">
                ...
                <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Home-dashboard"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Pie"></use>
                        </svg>
                ...
                <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Info-circle"></use>
                        </svg>
                        <h6 class="f-w-600">Project</h6><i class="iconly-Arrow-Right-2 icli"></i>
                    </a>
                    <ul class="sidebar-submenu">
                        <li> <a href="<?= base_url('admin/report'); ?>">Project list </a></li>
                        <li> <a href="<?= base_url('admin/createproject'); ?>">Project create </a></li>
                    </ul>
                </li>
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="file-manager.html">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Paper"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Wallet"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Bag"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Chat"></use>
                        </svg>
                ...
                <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                    ...
                    <ul class="sidebar-submenu">
                        <li> <a href="<?= base_url('admin/userprofile'); ?>">Users Profile</a></li>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="contacts.html">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Contacts"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="task.html">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Tick-square"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Calendar"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Camera"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="to-do.html">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Edit"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="search.html">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Search-sidebar"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="buttons.html">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#More-box"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Folder"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Ticket-star"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Category"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Activity"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Chart"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Filter"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Edit-line"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Paper-plus"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Play"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Star-kit"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Password"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Gallery"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Game"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"><a class="sidebar-link" href="faq.html">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Danger"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Filter-2"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Work"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Discovery"></use>
                        </svg>
                ...
                <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        href="javascript:void(0)">
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Shield"></use>
                        </svg>
                        <h6 class="f-w-600">Editors</h6><i class="iconly-Arrow-Right-2 icli"></i>
                    </a>
                    <ul class="sidebar-submenu">
                        <li> <a href="<?= base_url('admin/texteditor'); ?>">Quill editor</a></li>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Setting"></use>
                        </svg>
                ...
                <li class="sidebar-list d-none"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                        ...
                        <svg class="stroke-icon">
                            <use href="<?= base_url('assets/'); ?>images/iconly-sprite.svg#Ticket"></use>
                        </svg>
